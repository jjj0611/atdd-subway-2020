...
public class FavoriteDocumentation extends Documentation {
    ...
    void findFavorites() {
        List<FavoriteResponse> favoriteResponses = Lists.newArrayList(
            new FavoriteResponse(1L, new StationResponse(1L, "광교중앙역", LocalDateTime.now(), LocalDateTime.now()),
                new StationResponse(2L, "잠실역", LocalDateTime.now(), LocalDateTime.now())),
            new FavoriteResponse(2L, new StationResponse(3L, "강남역", LocalDateTime.now(), LocalDateTime.now()),
